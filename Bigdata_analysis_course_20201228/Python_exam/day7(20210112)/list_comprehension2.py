oldlist = [17,2,14,6,10,19,16,12,5]     # 2중리스트가 출력되기 때문에 비추
newlist1 = [ oldlist ]
print(newlist1)

newlist2 = list( [1,2,3,4,5,6,7,8] )    # 리스트
print(newlist2)

newlist3 = list( (1,2,3,4,5,6,7,8) )    # 튜플
print(newlist3)

newlist4 = list( {1,2,3,4,5,6,7,8} )    # 셋
print(newlist4)

newlist5 = list( "ABC")                 # 문자열
print(newlist5)
